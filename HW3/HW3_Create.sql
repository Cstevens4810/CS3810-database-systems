...
CREATE TABLE Flight(FLIGHT_NUMBER VARCHAR(10), DISTANCE INT, AIR_TIME VARCHAR(10), FREIGHT INT, PASSENGERS INT, ORIGIN_STATE_ABR VARCHAR(5), DEST_STATE_ABR VARCHAR(5), UNIQUE_CARRIER_ENTITY VARCHAR(10), PRIMARY KEY (FLIGHT_NUMBER), FOREIGN KEY (UNIQUE_CARRIER_ENTITY) REFERENCES Carrier(UNIQUE_CARRIER_ENTITY) );
